...
export const createQuiz = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res
      .status(500)
      .json(formatResponse("Error creating quiz", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const getQuiz = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res
      .status(500)
      .json(formatResponse("Error fetching quiz", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const getAllQuizzes = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res
      .status(500)
      .json(formatResponse("Error fetching quizzes", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const getQuizzesByDate = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    if (typeof start !== "string") {
      return res.status(400).json(formatResponse("Invalid or missing start date"));
    }
...
export const getArchivedQuizzesBySubject = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res.status(200).json(formatResponse("Archived quizzes fetched successfully", quizzes));
  } catch (error) {
    res
      .status(500)
      .json(formatResponse("Error fetching archived quizzes", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const getActiveQuizzes = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res.status(200).json(formatResponse("Active quizzes fetched successfully", quizzes));
  } catch (error) {
    res
      .status(500)
      .json(formatResponse("Error fetching active quizzes", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const updateQuiz = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res
      .status(500)
      .json(formatResponse("Error updating quiz", null, error instanceof Error ? error.message : String(error)));
  }
};
...
export const deleteQuiz = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    res
      .status(500)
      .json(formatResponse("Error deleting quiz", null, error instanceof Error ? error.message : String(error)));
  }
};
